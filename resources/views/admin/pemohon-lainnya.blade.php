...
<head>
    ...
    <title>Pemohon Lainnya - Admin</title>
    ...
    <div class="page-shell admin-shell">
        ...
        <section class="hero">
            <div class="hero-copy">
                ...
                <h2>Pemohon Lainnya</h2>
                <p>Daftar booking dari pemohon kategori lainnya.</p>
                @if (session('status'))
        ...
        <section class="info-grid admin-grid">
            <div class="card admin-section-card admin-bookings-card">
                ...
                <div class="booking-list">
                    ...
                    @empty
                        <p class="building-info">Belum ada booking dari kategori ini.</p>
                    @endforelse
                </div>
            </div>
        </section>
