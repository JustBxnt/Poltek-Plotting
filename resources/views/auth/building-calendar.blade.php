        ...
        <section class="hero">
            <div class="hero-copy">
                ...
                @if ($building->code === 'AH')
                    @php
                        $galleryPhotos = [
                            ['file' => 'Audit AH depan 1.jpeg', 'caption' => 'Tampak depan 1'],
                            ['file' => 'Audit AH depan 2.jpeg', 'caption' => 'Tampak depan 2'],
                            ['file' => 'Audit AH blkg 1.jpeg', 'caption' => 'Tampak belakang 1'],
                            ['file' => 'Audit AH belakang 2.jpeg', 'caption' => 'Tampak belakang 2'],
                        ];
                    @endphp

                    <div class="building-gallery">
                        <div class="building-gallery-header">
                            <p class="gallery-kicker">Foto Gedung AH</p>
                            <h3>Dokumentasi ruangan dan tampilan bangunan</h3>
                        </div>

                        <div class="building-gallery-grid">
                            @foreach ($galleryPhotos as $photo)
                                <figure class="building-photo-card">
                                    <img
                                        src="{{ asset('images/' . rawurlencode($photo['file'])) }}"
                                        alt="{{ $photo['caption'] }} Gedung AH"
                                        loading="lazy"
                                    >
